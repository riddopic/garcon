...
module Garcon
  ...
  module Inflections
    ...
    alias_method :convert_to_snake_case, :snakeify
...
require 'garcon/inflections/rules_collection'
require 'garcon/inflections/inflections'
require 'garcon/inflections/defaults'
