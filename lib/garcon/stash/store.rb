...
require 'thread'
require 'zlib'
require 'garcon/stash/serializer'
require 'garcon/stash/format'
require 'garcon/stash/queue'
require 'garcon/stash/journal'
require 'garcon/stash/store'
  ...
  module Stash
    ...
    class Store
      ...
      def initialize(file, options = {}, &block)
        opts = {
          serializer: options.fetch(:serializer, Serializer::Default),
      ...
      def self.exit_handler
        loop do
          ...
          begin
            ...
            warn "Failed to close stash store: #{ex.message}"
          end
        end
      end

      at_exit { Stash::store.exit_handler }
