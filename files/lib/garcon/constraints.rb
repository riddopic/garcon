...
module Garcon
  module Constraints
    ...
    #
    # @return [Garcon::Constraints::Version]
    #   the new version object
    #
    def version(version)
      Garcon::Constraints::Version.new(version)
    end
    ...
    #
    # @return [Garcon::Constraints::Constraint]
    #   the new constraint object
    #
    def constraint(*constraints)
      Garcon::Constraints::Constraint.new(*constraints)
    end
    ...
    #   Garcon::Version('1.2.3')
    #
    # @example Compare a version with constraints
    #   Garcon::Version('1.2.3').satisfies?('~> 1.3.4', '< 2.0.5')
    #
    class Version
  ...
  module DSL
    # @see Garcon::Constraints#version
    def version(version)
      Garcon::Constraints::Version.new(version)
    end

    # @see Garcon::Constraints#constraint
    def constraint(*constraints)
      Garcon::Constraints.constraint(*constraints)
    end
