...
module Garcon
  ...
  module Names
    include AtRandom
    ADJECTIVES = %w(autumn hidden bitter misty silent empty dry dark summer icy
      ...
      lingering bold little morning muddy old red rough still small sparkling
      throbbing shy wandering withered wild black young holy solitary fragrant
      aged snowy proud floral restless divine polished ancient purple lively
      nameless)

    NOUNS = %w(waterfall river breeze moon rain wind sea morning snow lake sunset
      pine shadow leaf dawn glitter forest hill cloud meadow sun glade bird brook
      ...
      violet water wildflower wave water resonance sun wood dream cherry tree fog
