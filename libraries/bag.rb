...
module Garcon
  ...
  # end
  #
  # my_password = secret 'passwords', 'b1gb1rd'
  #
  # That means my_password will == 'b1gb1rd'
  #
  # You also can provide a default password value in developer mode,
  # like following:
  #
  # node.set[:garcon][:secret][:passwd] = 'mysql_passwd'
  # mysql_passwd = secret 'passwords', 'sl0ppyj03'
  #
  # The mysql_passwd will == 'sl0ppyj03'
  #
  module Bag
    module ClassMethods
